//Cloned by AI (from com.example.screentests.services.ShakeDetector, for the standalone swarm showcase)
 ...
 * shake can scatter the bee swarm — in the showcase it is PERMANENTLY armed while the
 * simulation runs (no extra manifest permission is required for the accelerometer).
 *
